        ...
        <div class="bg-gradient-to-r from-red-800 to-red-900 rounded-lg shadow-lg p-6 mb-8">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-red-100 text-sm">Manage your educational resources and materials</p>
                </div>
                <a href="{{ route('teacher.materials.form') }}" 
                   class="bg-white text-red-800 hover:bg-red-50 px-6 py-3 rounded-lg shadow-md transition-all duration-200 font-semibold flex items-center gap-2 hover:shadow-lg transform hover:-translate-y-0.5">
        ...
        <div class="grid gap-6">
                ...
                <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 border border-gray-200 overflow-hidden">
                    ...
                    <div class="bg-gradient-to-r from-red-50 to-red-100 px-6 py-4 border-b border-red-200">
                        <div class="flex justify-between items-start">
                            ...
                            <div class="bg-red-700 text-white px-3 py-1 rounded-full text-xs font-medium">
                                Material
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6">
                        @if ($material->instructions)
                            <div class="mb-4 p-4 bg-gray-50 rounded-lg border-l-4 border-red-700">
                        ...
                        <div class="mb-6 p-4 bg-red-50 rounded-lg border border-red-200">
                            <div class="flex items-center justify-between">
                                ...
                                <a href="{{ asset('storage/' . $material->file_path) }}" 
                                   target="_blank" 
                                   class="bg-red-700 hover:bg-red-800 text-white px-4 py-2 rounded-lg font-medium transition-colors duration-200 flex items-center gap-2">
                        ...
                        <div class="flex gap-3 pt-4 border-t border-gray-100">
                            <a href="{{ route('teacher.materials.edit', $material->id) }}" 
                               class="flex-1 px-4 py-2 bg-red-600 hover:bg-red-700 text-white text-sm rounded-lg font-medium transition-all duration-200 text-center flex items-center justify-center gap-2 hover:shadow-md">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <form action="{{ route('teacher.materials.destroy', $material->id) }}" 
                                ...
                                @csrf
                                @method('DELETE')
                                <button class="w-full px-4 py-2 bg-red-800 hover:bg-red-900 text-white text-sm rounded-lg font-medium transition-all duration-200 flex items-center justify-center gap-2 hover:shadow-md">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            @empty
                ...
                <div class="text-center py-16">
                    <div class="bg-red-50 rounded-full w-24 h-24 mx-auto mb-6 flex items-center justify-center">
                    ...
                    <a href="{{ route('teacher.materials.form') }}" 
                       class="inline-flex items-center gap-2 bg-red-700 hover:bg-red-800 text-white px-6 py-3 rounded-lg font-semibold transition-all duration-200 hover:shadow-lg transform hover:-translate-y-0.5">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                        </svg>
