<x-app-layout>
    <div class="w-full min-h-screen bg-gray-50 px-4 py-8">
        <!-- Header Section -->
        <div class="bg-gradient-to-r from-red-800 to-red-900 rounded-lg shadow-lg p-6 mb-8">
            <div class="flex justify-between items-center">
                <div>
                    <h2 class="text-2xl font-bold text-white mb-2">Add New Material</h2>
                    <p class="text-red-100 text-sm">Upload educational resources for your students</p>
                </div>
                <a href="{{ route('teacher.materials.index') }}"
                   class="bg-white text-red-800 hover:bg-red-50 px-4 py-2 rounded-lg shadow-md transition-all duration-200 font-medium flex items-center gap-2 hover:shadow-lg transform hover:-translate-y-0.5">
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
            <div class="bg-gradient-to-r from-red-50 to-red-100 px-6 py-4 border-b border-red-200">
                <div class="flex items-center">
                    <svg class="w-6 h-6 text-red-700 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <form action="{{ route('teacher.materials.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" 
                           ...
                           required 
                           value="{{ old('title') }}"
                           class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-red-600 focus:border-red-600 transition-colors duration-200 bg-gray-50 focus:bg-white"
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="instructions" 
                              rows="4" 
                              class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-red-600 focus:border-red-600 transition-colors duration-200 bg-gray-50 focus:bg-white resize-none"
                ...
                <div class="space-y-2">
                    ...
                    <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-red-500 transition-colors duration-200 bg-gray-50">
                        <div class="space-y-3">
                            ...
                            <div>
                                <input type="file" 
                                       ...
                                       required 
                                       class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-red-700 file:text-white hover:file:bg-red-800 file:cursor-pointer cursor-pointer transition-all duration-200">
                            </div>
                            <div class="text-sm text-gray-500">
                                ...
                                <div class="flex justify-center gap-4 mt-2">
                                    ...
                                    <span class="bg-red-100 text-red-700 px-2 py-1 rounded text-xs font-medium">DOC</span>
                                    <span class="bg-red-100 text-red-700 px-2 py-1 rounded text-xs font-medium">DOCX</span>
                ...
                <div class="pt-6 border-t border-gray-100">
                    <div class="flex gap-4">
                        <button type="submit" 
                                class="flex-1 bg-gradient-to-r from-red-700 to-red-800 hover:from-red-800 hover:to-red-900 text-white px-6 py-3 rounded-lg shadow-md font-semibold transition-all duration-200 flex items-center justify-center gap-2 hover:shadow-lg transform hover:-translate-y-0.5">
        ...
        <div class="mt-8 bg-red-50 rounded-lg p-6 border border-red-200">
            <div class="flex items-start">
                ...
                <div>
                    <h4 class="font-semibold text-red-800 mb-2">Tips for uploading materials:</h4>
