    ...
    <div class="max-w-6xl mx-auto mt-8 px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center mb-4">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-red-800 mb-2">Learning Materials</h1>
            ...
            <div class="bg-gradient-to-r from-red-50 to-red-100 rounded-lg p-4 border border-red-200">
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        <svg class="w-5 h-5 text-red-800 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                        </svg>
                        <span class="text-red-800 font-medium">{{ count($materials) }} Materials Available</span>
                    </div>
                    <div class="flex items-center">
        ...
        <div class="space-y-6">
            @forelse($materials as $material)
                <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden hover:shadow-xl transition-all duration-300 hover:border-red-200">
                    <!-- Material Header -->
                            ...
                            <div class="flex-1">
                                ...
                                <div class="flex items-center text-sm text-gray-600">
                                    <div class="flex items-center mr-6">
                                        <div class="bg-red-100 rounded-full w-8 h-8 flex items-center justify-center mr-2">
                                            <svg class="w-4 h-4 text-red-800" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                                            </svg>
                                        </div>
                                        <span>Uploaded by: <span class="font-medium text-red-800">{{ $material->teacher->name ?? 'N/A' }}</span></span>
                                    </div>
                                    <div class="flex items-center">
                        ...
                        @if($material->file_path)
                            <div class="flex items-center justify-between bg-red-50 rounded-lg p-4 border border-red-200">
                                ...
                                <a href="{{ asset('storage/' . $material->file_path) }}"
                                   target="_blank"
                                   class="inline-flex items-center px-6 py-3 bg-red-800 hover:bg-red-900 text-white font-medium rounded-lg shadow-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-red-800 focus:ring-offset-2 hover:shadow-md transform hover:scale-105">
                    ...
                    <div class="text-center">
                        ...
                        <div class="bg-red-50 rounded-lg p-4 max-w-md mx-auto">
                            <div class="flex items-center justify-center">
                                ...
                                <span class="text-red-800 text-sm font-medium">Materials will appear here when uploaded</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="mt-8 pt-6 border-t border-gray-200">
            <a href="{{ route('student.dashboard') }}"
               class="inline-flex items-center px-4 py-2 text-red-800 hover:text-red-900 font-medium transition-colors duration-200">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
