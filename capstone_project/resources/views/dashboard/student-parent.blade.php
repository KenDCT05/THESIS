    ...
    <div class="max-w-6xl mx-auto mt-8 px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <a href="{{ route('student.materials') }}"
               class="inline-flex items-center px-6 py-3 bg-pink-600 hover:bg-pink-700 text-white font-medium rounded-lg shadow-sm transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
